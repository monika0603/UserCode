...
class ThreeParticleAnalyzer
{
  public:
   ...
   // TH2D *DivideOnly(TH2D *hSignal, TH2D *hBackground);
...
TH2D *CrossEtaRegion(TFile *fRead, const int cent)
{
    ...
    TH2D *hSig_crossEtaRegion = DivideAndScale(hSignal_cEtaRegion, hBackground_cEtaRegion, hEvents);
...
TH2D *SD_sameEtaRegion(TFile *fRead, const int cent)
{
    ...
    TH2D *hSig_SD_sEtaRegion = DivideAndScale(hSignal_SD_sEtaRegion, hBackground_SD_sEtaRegion, hEvents);
...
TH2D *SD_crossEtaRegion(TFile *fRead, const int cent)
{
    ...
    TH2D *hSig_SD_cEtaRegion = DivideAndScale(hSignal_SD_cEtaRegion, hBackground_SD_cEtaRegion, hEvents);
